 ...
 * </pre>
 */
@Component(value = "refundHandler")
public class RefundHandler implements AccountTradeHandler {
	...
	public boolean execute(Map<String, Object> params, Account account) throws Exception {
		...
		//解析参数
		 if(BaseTradeParams.checkPrams(params, RechargeParams.values()))
		 {
			...
			//执行交易
			flage = account.income(amount, DefaultAccountTradeType.REFUND,billNo, CumulativeType.UNCHANGED);
		 }
		return flage;	
	}
